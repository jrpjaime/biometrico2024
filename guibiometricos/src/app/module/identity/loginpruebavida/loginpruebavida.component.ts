...
@Component({
	selector: 'app-login',
	templateUrl: './loginpruebavida.component.html',
	styleUrls: ['./loginpruebavida.component.css']
})
export class LoginpruebavidaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.loginForm = this.formBuilder.group({
      curp: ['', [Validators.required, Validators.pattern(PATTERN.curp)]],
